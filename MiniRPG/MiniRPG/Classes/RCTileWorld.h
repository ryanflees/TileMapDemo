...
class RCTileWorld : public cocos2d::CCLayer, RCWorldProcessorDelegate
{
...
public:
    ...
    virtual cocos2d::CCSize onGetWorldSize(RCWorldProcessor* worldProcessor);
    virtual cocos2d::CCSize onGetWorldSizeInPixels(RCWorldProcessor* worldProcessor);
...
private:
    ...
    RCWorldProcessor *m_worldProcessor;
