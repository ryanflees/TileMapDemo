...
public:
    ...
    virtual void handleTouchesBegin(int num, int ids[], float xs[], float ys[], unsigned int hash[]);
    virtual void handleTouchesMove(int num, int ids[], float xs[], float ys[], unsigned int hash[]);
    virtual void handleTouchesEnd(int num, int ids[], float xs[], float ys[], unsigned int hash[]);
    virtual void handleTouchesCancel(int num, int ids[], float xs[], float ys[], unsigned int hash[]);
...
private:
    void getSetOfTouchesEndOrCancel(CCSet& set, int num, int ids[], float xs[], float ys[], unsigned int hash[]);
